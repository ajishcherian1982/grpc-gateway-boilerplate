...
func (c *userServiceClient) AddUser(ctx context.Context, in *AddUserRequest, opts ...grpc.CallOption) (*ExampleUser, error) {
	out := new(ExampleUser)
...
func (x *userServiceListUsersClient) Recv() (*ExampleUser, error) {
	m := new(ExampleUser)
...
func (x *userServiceListUsersServer) Send(m *ExampleUser) error {
